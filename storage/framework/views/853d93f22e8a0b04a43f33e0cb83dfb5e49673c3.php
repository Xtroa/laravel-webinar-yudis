...
<body>
                    ...
                    <div>
                        <?php if(Route::has('login')): ?>
                            <?php if(auth()->guard()->check()): ?>
                                ...
                                <?php else: ?>
                                    <a style="margin-left: 20px; color: white;" href="<?php echo e(url('/home')); ?>">Artikel</a>
                                <?php endif; ?>
                            <?php else: ?>
                                <span class="navbar-text">
                                    <ul class="navbar-nav mr-auto">
                                        <li class="nav-item">
                                            <a style="margin-left: 20px; color: white;" class="nav-link" href="<?php echo e(url('login')); ?>">Login</a>
                                        </li>
                                    </ul>
                                </span>
    ...
    <div class="container main" style="margin-top: 50px; margin-bottom: 50px;">
        <h3 class="" style="align-center; margin-bottom: 50px;">
